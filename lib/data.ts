...
export const faqs = [
  ...
  { q: "Can you integrate directly with our existing ML infrastructure?", a: "Yes. We deliver data in all industry-standard formats (COCO JSON, YOLO TXT, JSON-L, etc.) and can build automated APIs or secure bucket integrations that feed perfectly labeled data directly into your existing CI/CD ML pipelines." },
  { q: "Do you support highly regulated industries like Healthcare?", a: "Yes. We have extensive experience in healthcare, finance, and autonomous defense. We provide fully HIPAA-compliant environments with executed Business Associate Agreements (BAAs) for processing sensitive medical imaging and EHR data." },
  { q: "How do we initiate an enterprise engagement or pilot?", a: "Engagements typically begin with a deep-dive technical consultation. We encourage organizations to start with a scoped pilot project to evaluate our data quality, engineering speed, and pipeline architecture before executing a full Master Services Agreement (MSA)." },
];
