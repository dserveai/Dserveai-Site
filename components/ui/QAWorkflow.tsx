...
import { ShieldCheck, FileText, FileAudio, FileImage } from "lucide-react";
...
export default function QAWorkflow({ steps, color }: Props) {
        ...
        <div className={`${styles.mapCore} ${hoveredIdx !== null ? styles[`mode-${hoveredIdx}`] : ''}`}>
          ...
          <div className={styles.dataStream}>
            <div className={styles.dataItem}>
              <FileImage size={16} />
              <div className={`${styles.validationTag} ${styles.tagPass}`}>[Valid]</div>
            </div>
            <div className={styles.dataItem}>
              <FileText size={16} />
              <div className={`${styles.validationTag} ${styles.tagFail}`}>[Error]</div>
              <div className={`${styles.validationTag} ${styles.tagPass}`}>[Fixed]</div>
            </div>
            <div className={styles.dataItem}>
              <FileAudio size={16} />
              <div className={`${styles.validationTag} ${styles.tagPass}`}>[Valid]</div>
          ...
          {/* Inspection Lens */}
          <div className={styles.inspectionLens} />
