...
import { ScanFace, Car, User, Box } from "lucide-react";
import styles from "./ComputerVisionWorkflow.module.css";
...
export default function ComputerVisionWorkflow({ steps, color }: Props) {
    ...
    <div className={styles.container} style={{ "--c": color } as React.CSSProperties}>
      ...
      <div className={styles.centralMap}>
        <div className={`${styles.mapCore} ${hoveredIdx !== null ? styles[`mode-${hoveredIdx}`] : ''}`}>
          ...
          {/* Tracking Crosshair (Appears on Hover) */}
          <div className={styles.crosshair} />

          {/* Orbiting Objects */}
          <div className={styles.trackingLayer}>
            <div className={`${styles.targetObject} ${styles.obj1}`}><Car size={20} /></div>
            <div className={`${styles.targetObject} ${styles.obj2}`}><User size={20} /></div>
            <div className={`${styles.targetObject} ${styles.obj3}`}><Box size={20} /></div>
          </div>
