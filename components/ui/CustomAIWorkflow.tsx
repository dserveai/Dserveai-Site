...
import styles from "./CustomAIWorkflow.module.css";
...
export default function CustomAIWorkflow({ steps, color }: Props) {
  ...
  return (
    <div className={styles.container} style={{ "--c": color } as React.CSSProperties}>
      ...
      {/* Neural Architecture Compiler Graph */}
      <div className={styles.architectureGraph}>
        <div className={`${styles.graphCore} ${hoveredIdx !== null ? styles[`mode-${hoveredIdx}`] : ''}`}>
          
          {/* Paths (Connections) */}
          <div className={`${styles.path} ${styles.p1}`} style={{ "--top": "15%" } as React.CSSProperties}><div className={styles.packet} /></div>
          <div className={`${styles.path} ${styles.p2}`} style={{ "--top": "35%" } as React.CSSProperties}><div className={styles.packet} /></div>
          <div className={`${styles.path} ${styles.p3}`} style={{ "--top": "35%" } as React.CSSProperties}><div className={styles.packet} /></div>
          <div className={`${styles.path} ${styles.p4}`} style={{ "--top": "15%" } as React.CSSProperties}><div className={styles.packet} /></div>
          <div className={`${styles.path} ${styles.p5}`} style={{ "--top": "65%" } as React.CSSProperties}><div className={styles.packet} /></div>
          <div className={`${styles.path} ${styles.p6}`} style={{ "--top": "65%" } as React.CSSProperties}><div className={styles.packet} /></div>

          {/* Nodes */}
          <div className={`${styles.node} ${styles.n1}`}><Database size={16} /></div>
          <div className={`${styles.node} ${styles.n2}`}><Network size={16} /></div>
          <div className={`${styles.node} ${styles.n3}`}><Cpu size={16} /></div>
          <div className={`${styles.node} ${styles.n4}`}><Database size={16} /></div>
          <div className={`${styles.node} ${styles.n5}`}><Network size={16} /></div>
          <div className={`${styles.node} ${styles.n6}`}><Cpu size={16} /></div>
          
          {/* Central Hub */}
          <div className={styles.hub}><Network size={32} /></div>

          {/* API Endpoint Core */}
          <div className={styles.apiEndpoint}>
            <div style={{ textAlign: "center" }}>
              <Server size={32} />
              <div style={{ fontSize: "10px", marginTop: "4px", fontWeight: "bold" }}>READY</div>
            </div>
          </div>
