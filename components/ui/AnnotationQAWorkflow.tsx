...
import styles from "./AnnotationQAWorkflow.module.css";
...
export default function AnnotationQAWorkflow({ steps, color }: Props) {
  ...
  return (
    <div className={styles.container} style={{ "--c": color } as React.CSSProperties}>
      ...
      {/* Central Matrix Engine */}
      <div className={styles.centralMatrix}>
        <div className={`${styles.matrixCore} ${hoveredIdx !== null ? styles[`mode-${hoveredIdx}`] : ''}`}>
          
          <div className={styles.gridLines} />
          
          {/* Data Points */}
          <div className={styles.dataPointsContainer}>
            <div className={`${styles.dataPoint} ${styles.dp1}`} />
            <div className={`${styles.dataPoint} ${styles.dp2}`} />
            <div className={`${styles.dataPoint} ${styles.dp3}`} />
            <div className={`${styles.dataPoint} ${styles.dp4}`} />
            <div className={`${styles.dataPoint} ${styles.dp5}`} />
          </div>

          {/* Scanner Arm */}
          <div className={styles.scannerArm}>
            <div className={styles.scannerBeam} />
          </div>

          {/* Bounding Boxes */}
          <div className={`${styles.boundingBox} ${styles.bb1}`}>
            <span className={`${styles.qaTag} ${styles.tagPass}`}>Valid: 99%</span>
          </div>
          <div className={`${styles.boundingBox} ${styles.bb2}`} />
          <div className={`${styles.boundingBox} ${styles.bb3}`}>
            <span className={`${styles.qaTag} ${styles.tagWarn}`}>Edge Case</span>
          </div>
          <div className={`${styles.boundingBox} ${styles.bb4}`} />
          <div className={`${styles.boundingBox} ${styles.bb5}`} />
