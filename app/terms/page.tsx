      ...
      <main style={{ paddingTop: "140px", paddingBottom: "80px", minHeight: "80vh" }}>
        <div className="container" style={{ maxWidth: "800px", margin: "0 auto" }}>
          ...
          <article style={{ color: "rgba(255,255,255,0.7)", fontSize: "1.05rem", lineHeight: 1.8 }}>
            ...
            <p style={{ marginBottom: "24px" }}>
              If you have any questions regarding these Terms of Service, please contact us at <a href="mailto:legal@dserveai.com" style={{ color: "#0ea5e9" }}>legal@dserveai.com</a>.
            </p>
          </article>
        </div>
      </main>
